...
<body class="body_bg">
    ...
    <div class="uc_content txt_cen">
    	<h2 class="h2 h2_1"><span class="span">论述题</span></h2>
    </div>
   ...
   <jsp:include page="../product/cursor.jsp" />
    ...
    <form action="center/addoptquestion" id="addoptquestion">
    	<input name="type" type="hidden" value="${type}">
     	<input name="gid" type="hidden" value="6">
        ...
        <jsp:include page="up_pic.jsp"></jsp:include>
...
<form action="center/discussEntry" method="post" id="reload_self_fm">

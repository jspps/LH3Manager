...
public class DateUtil {
	...
	/**
	 * 长日期格式(yyyyMMddHHmmssSSS)
	 */
	public static final String LONG_DATE_NO_SIGN_PATTERN_SSS = "yyyyMMddHHmmssSSS";
	...
	/**
	 * 按照日期格式(yyyyMMddHHmmssSSS)转换日期对象为字符串日期
	 * 
	 * @param date
	 *            日期对象
	 * @return 字符串日期
	 */
	public static String fromatShortNoSignSSS(Date date) {
		return format(date, LONG_DATE_NO_SIGN_PATTERN_SSS);
	}
